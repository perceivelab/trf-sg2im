...
class COCODataModule(BaseDataModule):
        def __init__(self, data_dir="data", **kwargs):
                ...
                train_image_dir = 'data/coco/images/train2017'
                val_image_dir = 'data/coco/images/val2017'
                ...
                self.train_ds = CocoSceneGraphDataset(train_image_dir, train_inst_json, train_stuff_json, stuff_only=False, **kwargs)
                self.val_ds = CocoSceneGraphDataset(val_image_dir, val_inst_json, val_stuff_json, stuff_only=False, **kwargs)
