...
# Input data
parser.add_argument('--splits_json', default='data/vg/vg_splits.json')
parser.add_argument('--images_json',
            default=VG_DIR / 'image_data.json')
parser.add_argument('--objects_json',
            default=VG_DIR / 'objects.json')
parser.add_argument('--attributes_json',
            default=VG_DIR / 'attributes.json')
parser.add_argument('--object_aliases',
            default=VG_DIR / 'object_alias.txt')
parser.add_argument('--relationship_aliases',
            default=VG_DIR / 'relationship_alias.txt')
parser.add_argument('--relationships_json',
            default=VG_DIR / 'relationships.json')
...
# Output
parser.add_argument('--output_vocab_json', default=VG_DIR / 'new/vocab.json')
parser.add_argument('--output_h5_dir', default=VG_DIR / 'new')
...
def main(args):
  ...
  # Defines aliases to have the same name for similar object
  ...
  # Remove objects too small, collapse names to aliases
